...
st.markdown(f"{hp123.sample()['MovieName']} {hp123.sample()['MovieNumber']} {hp123.sample()['Character']} {hp123.sample()['House']} {hp123.sample()['Sentence']} Number of words: {str(hp123.sample()['numWords'])}")
