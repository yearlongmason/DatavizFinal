...
#Not planning on using a gender column, but I had it for a time
'''#Creating a gender column
male=['Dumbledore', 'Hagrid', 'Dudley', 'Vernon', 'Harry', 'Snake', 'Barkeep', 'Quirrell', 'Griphook', 'Ollivander',\
     'Train Master', 'George', 'Fred', 'Ron', 'Neville', 'Draco', 'Seamus', 'Percy', 'Sir Nicholas', 'Man in Painting',\
     'Snape', 'Dean', 'Filch', 'Oliver Wood', 'Flitwick', 'Ron and Harry', 'LeeJordan', 'Flint', 'Firenze', 'Voldemort']
female=['McGonagall', 'Petunia', 'Mrs.Weasley', 'Ginny', 'Trolley Witch', 'Hermione', 'Fat Lady', 'Madam Hooch']
other=['Background Character', 'Sorting Hat', 'Students', 'Harry, Ron, and Hermione']

hp1Genders=[]
for i in hp1['Character']:
    if i in male:
        hp1Genders.append('Male')
    elif i in female:
        hp1Genders.append('Female')
    else:
        hp1Genders.append('Other')   
hp1['Gender'] = hp1Genders'''
